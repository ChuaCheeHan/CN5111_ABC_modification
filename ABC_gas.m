...
for (b = 1:10)
    ...
    v1 = bees(b,:);
    v2 = bees(b,:);
    v1(a) = bees(b, a) + v_Fz1(b,a)*(bees(b,a) - bees(x_randomval, a));
    v2(a) = bees(b, a) + v_Fz2(b,a)*(bees(b,a) - bees(x_randomval, a));
    if (f(v1(1), v1(2)) < f(v2(1), v2(2)))
        newv = v1;
        v_b(b,a) = v_Fz2(b,a);
    else newv = v2;
        v_a(b,a) = v_Fz1(b,a);
...
v1 = bees(p_idx,:);
v2 = bees(p_idx,:);
v1(a) = bees(p_idx,a) + v_Fz1(p_idx,a)*(bees(p_idx,a) - bees(x_randomval,a));
v2(a) = bees(p_idx,a) + v_Fz2(p_idx,a)*(bees(p_idx,a) - bees(x_randomval,a));
if (f(v1(1),v1(2)) < f(v2(1), v2(2)))
    newv = v1;
