...
for (i = 1:5)
    v1b1_Fz1(i) = v1b1_b(i) - (v1b1_b(i)-v1b1_a(i))/((1+sqrt(5))/2);
    v1b1_Fz2(i) = v1b1_a(i) + (v1b1_b(i)-v1b1_a(i))/((1+sqrt(5))/2);
    v1b2_Fz1(i) = v1b2_b(i) - (v1b2_b(i)-v1b2_a(i))/((1+sqrt(5))/2);
    v1b2_Fz2(i) = v1b2_a(i) + (v1b2_b(i)-v1b2_a(i))/((1+sqrt(5))/2);
    v2b1_Fz1(i) = v2b1_b(i) - (v2b1_b(i)-v2b1_a(i))/((1+sqrt(5))/2);
    v2b1_Fz2(i) = v2b1_a(i) + (v2b1_b(i)-v2b1_a(i))/((1+sqrt(5))/2);
    v2b2_Fz1(i) = v2b2_b(i) - (v2b2_b(i)-v2b2_a(i))/((1+sqrt(5))/2);
    v2b2_Fz2(i) = v2b2_a(i) + (v2b2_b(i)-v2b2_a(i))/((1+sqrt(5))/2);
end
...
for (i = 1:5)
    ...
    v1 = var1_bee1(i) + v1b1_Fz1(i)*(var1_bee1(i) - var1_bee1(x_randomval));
    v2 = var1_bee1(i) + v1b1_Fz2(i)*(var1_bee1(i) - var1_bee1(x_randomval));
    if (f(v1, var2_min) < f(v2, var2_min))
        newv = v1;
        v1b1_b(i) = v1b1_Fz2(i);
    else newv = v2;
        v1b1_a(i) = v1b1_Fz1(i);
    ...
    v1 = var1_bee2(i) + v1b2_Fz1(i)*(var1_bee2(i) - var1_bee2(x_randomval));
    v2 = var1_bee2(i) + v1b2_Fz2(i)*(var1_bee2(i) - var1_bee2(x_randomval));
    if (f(v1, var2_min) < f(v2, var2_min))
        newv = v1;
        v1b2_b(i) = v1b2_Fz2(i);
    else newv = v2;
    ...
    v1 = var2_bee1(i) + v2b1_Fz1(i)*(var2_bee1(i) - var2_bee1(x_randomval));
    v2 = var2_bee1(i) + v2b1_Fz2(i)*(var2_bee1(i) - var2_bee1(x_randomval));
    if (f(var1_min, v1) < f(var1_min, v2))
        newv = v1;
        v2b1_b(i) = v2b1_Fz2(i);
    else newv = v2;
        v2b1_a(i) = v2b1_Fz1(i);
    ...
    v1 = var2_bee2(i) + v2b2_Fz1(i)*(var2_bee2(i) - var2_bee2(x_randomval));
    v2 = var2_bee2(i) + v2b2_Fz2(i)*(var2_bee2(i) - var2_bee2(x_randomval));
    if (f(var1_min, v1) < f(var1_min, v2))
        newv = v1;
        v2b2_b(i) = v2b2_Fz2(i);
    else newv = v2;
...
v1b1_Fz1(p_idx) = v1b1_b(p_idx) - (v1b1_b(p_idx)-v1b1_a(p_idx))/((1+sqrt(5))/2);
v1b1_Fz2(p_idx) = v1b1_a(p_idx) + (v1b1_b(p_idx)-v1b1_a(p_idx))/((1+sqrt(5))/2);
x_randomval = randi(5);
while (x_randomval == p_idx)
    x_randomval = randi(5);
end
v1 = var1_bee1(p_idx) + v1b1_Fz1(p_idx)*(var1_bee1(p_idx) - var1_bee1(x_randomval));
v2 = var1_bee1(p_idx) + v1b1_Fz2(p_idx)*(var1_bee1(p_idx) - var1_bee1(x_randomval));
if (f(v1, var2_min) < f(v2, var2_min))
    newv = v1;
    v1b1_b(p_idx) = v1b1_Fz2(p_idx);
else newv = v2;
    v1b1_a(p_idx) = v1b1_Fz1(p_idx);
end
...
x(end) = 1e3*eps + x(end);
[p_val p_idx] = histc(rand,x);
v1b2_Fz1(p_idx) = v1b2_b(p_idx) - (v1b2_b(p_idx)-v1b2_a(p_idx))/((1+sqrt(5))/2);
v1b2_Fz2(p_idx) = v1b2_a(p_idx) + (v1b2_b(p_idx)-v1b2_a(p_idx))/((1+sqrt(5))/2);
x_randomval = randi(5);
while (x_randomval == p_idx)
    x_randomval = randi(5);
end
v1 = var1_bee2(p_idx) + v1b2_Fz1(p_idx)*(var1_bee2(p_idx) - var1_bee2(x_randomval));
v2 = var1_bee2(p_idx) + v1b2_Fz2(p_idx)*(var1_bee2(p_idx) - var1_bee2(x_randomval));
if (f(v1, var2_min) < f(v2, var2_min))
    newv = v1;
    v1b2_b(p_idx) = v1b2_Fz2(p_idx);
else newv = v2;
    v1b2_a(p_idx) = v1b2_Fz1(p_idx);
end
...
x(end) = 1e3*eps + x(end);
[p_val p_idx] = histc(rand,x);
v2b1_Fz1(p_idx) = v2b1_b(p_idx) - (v2b1_b(p_idx)-v2b1_a(p_idx))/((1+sqrt(5))/2);
v2b1_Fz2(p_idx) = v2b1_a(p_idx) + (v2b1_b(p_idx)-v2b1_a(p_idx))/((1+sqrt(5))/2);
x_randomval = randi(5);
while (x_randomval == p_idx)
    x_randomval = randi(5);
end
v1 = var2_bee1(p_idx) + v2b1_Fz1(p_idx)*(var2_bee1(p_idx) - var2_bee1(x_randomval));
v2 = var2_bee1(p_idx) + v2b1_Fz2(p_idx)*(var2_bee1(p_idx) - var2_bee1(x_randomval));
if (f(var1_min, v1) < f(var1_min, v2))
    newv = v1;
    v2b1_b(p_idx) = v2b1_Fz2(p_idx);
else newv = v2;
    v2b1_a(p_idx) = v2b1_Fz1(p_idx);
end
...
x(end) = 1e3*eps + x(end);
[p_val p_idx] = histc(rand,x);
v2b2_Fz1(p_idx) = v2b2_b(p_idx) - (v2b2_b(p_idx)-v2b2_a(p_idx))/((1+sqrt(5))/2);
v2b2_Fz2(p_idx) = v2b2_a(p_idx) + (v2b2_b(p_idx)-v2b2_a(p_idx))/((1+sqrt(5))/2);
x_randomval = randi(5);
while (x_randomval == p_idx)
    x_randomval = randi(5);
end
v1 = var2_bee2(p_idx) + v2b2_Fz1(p_idx)*(var2_bee2(p_idx) - var2_bee2(x_randomval));
v2 = var2_bee2(p_idx) + v2b2_Fz2(p_idx)*(var2_bee2(p_idx) - var2_bee2(x_randomval));
if (f(var1_min, v1) < f(var1_min, v2))
    newv = v1;
    v2b2_b(p_idx) = v2b2_Fz2(p_idx);
else newv = v2;
    v2b2_a(p_idx) = v2b2_Fz1(p_idx);
end
